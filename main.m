%% MOID ALGORITHM
% Anivid Pedros Faura - ORCCA LAB

% Calc MOID between two bodies for given: 
% semi-major axis [AU]
% eccentricity
% inclination (i) [deg]
% longitude of ascending node (Ω) [deg]
% argument of perhielion (ω) [deg], longitude of ascending node (Ω),

% Result is MOID in AU.
clc
clear
close all
...
A.sma =2.7691652;
A.e = 0.0760091;
A.argp = deg2rad(73.59764);
A.Omega = deg2rad(80.30553);
A.i = deg2rad(10.59407);
%% Orbital parameters of body B
B.sma = 2.3655722;
B.e = 0.127581;
B.argp = deg2rad(87.42605);
B.Omega = deg2rad(307.46872);
B.i = deg2rad(2.09575);
